...
@Component({
  selector: 'app-transie-casestudies',
  templateUrl: './transie-casestudies.component.html',
  styleUrls: ['./transie-casestudies.component.css']
})
export class TransieCasestudiesComponent implements OnInit {
  title = '';
