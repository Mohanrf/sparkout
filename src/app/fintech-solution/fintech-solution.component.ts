...
@Component({
  selector: 'app-fintech-solution',
  templateUrl: './fintech-solution.component.html',
  styleUrls: ['./fintech-solution.component.css']
})
export class FintechSolutionComponent implements OnInit {
